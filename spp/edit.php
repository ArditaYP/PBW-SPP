...
<body>
    <center>
        ...
        <form method="POST" action="prosesedit.php">
            <input type="text" placeholder="id_spp" name="id_spp" value="<?php echo $data['id_spp']; ?>"><br><br>
            <input type="text" placeholder="tahun" name="tahun" value="<?php echo $data['tahun']; ?>"><br><br>
